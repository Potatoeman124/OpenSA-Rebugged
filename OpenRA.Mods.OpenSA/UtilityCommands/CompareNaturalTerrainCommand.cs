	...
	sealed class CompareNaturalTerrainCommand : IUtilityCommand
	{
		...
		void IUtilityCommand.Run(Utility utility, string[] args)
		{
			...
			if (args[1] == "--player-evidence")
			{
				...
				if (requested.GeneratorVersion is not (11 or 12 or 13 or 14))
					throw new ArgumentException("Player terrain evidence requires Regions V11/V12/V13/V14 settings.");
				...
				{
					WaterPercent = RmgGenerator.RegionsWaterPercent(requested.WaterAmount),
					...
					Continuity = requested.GeneratorVersion is 12 or 13 or 14,
					ExtendedComplexity = requested.GeneratorVersion is 13 or 14
				};
