...
namespace OpenRA.Mods.OpenSA.Rmg
{
	...
	public sealed class RmgGenerationSettings
	{
		...
		public int EffectiveNeutralColonyCount => GeneratorVersion is 15 or 16 or 17 or 18 or 19 or 20 or 21 && NeutralColonyWeights.Total == 0 ? 0 : NeutralColonyCount;
		...
		public string Canonical(RmgProfile profile)
		{
			...
			if (GeneratorVersion is 11 or 12 or 13 or 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21)
			...
			if (GeneratorVersion >= 7)
			{
				...
				fields.Add($"{(GeneratorVersion is 11 or 12 or 13 or 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21 ? "gravel-moss-amount" : "tactical-terrain")}={RmgPlayerSettingsContract.ParameterLevelName(TacticalTerrain)}");
			}

			if (GeneratorVersion is 11 or 12 or 13 or 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21)
				fields.Add($"terrain-complexity={RmgPlayerSettingsContract.ComplexityDisplayName(TerrainComplexity, GeneratorVersion is 13 or 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21)}");
			...
			if (GeneratorVersion is 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21)
				fields.Add($"prevent-colony-overlapping={PreventColonyOverlapping.ToString().ToLowerInvariant()}");

			if (GeneratorVersion is 15 or 16 or 17 or 18 or 19 or 20 or 21)
				fields.Add($"neutral-colony-weights={NeutralColonyWeights.ToJson().ToString(Newtonsoft.Json.Formatting.None)}");

			if (GeneratorVersion is 16 or 17 or 18 or 19 or 20 or 21)
				fields.Add($"starting-colony-shares={string.Join(",", StartingColonyShares)}");

			if (GeneratorVersion is 16 or 17 or 18 or 19 or 20 or 21 && StartingColonyMode != RmgColonyOwnershipMode.ClosestToSpawn)
	...
	public sealed class RmgProfile
	{
		...
		public bool UsesRegionsTerrain => GeneratorVersion is 11 or 12 or 13 or 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21;
		public bool UsesNaturalTerrainMorphology => GeneratorVersion is 9 or 10 or 11 or 12 or 13 or 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21;
		...
		public int RockLandPercentFor(RmgParameterLevel tacticalTerrain) => tacticalTerrain switch
		{
			...
			RmgParameterLevel.Extreme when GeneratorVersion is 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21 => 24,
			RmgParameterLevel.Ultra when GeneratorVersion is 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21 => 36,
			_ => RockLandPercent
		};
		...
		public int VegetationLandPercentFor(RmgParameterLevel tacticalTerrain) => tacticalTerrain switch
		{
			...
			RmgParameterLevel.Extreme when GeneratorVersion is 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21 => 16,
			RmgParameterLevel.Ultra when GeneratorVersion is 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21 => 25,
		...
		{
			if (settings.TopologyPreset is RmgTopologyPreset.NaturalRegions or RmgTopologyPreset.PlannedBattlefield or RmgTopologyPreset.Crossroads or RmgTopologyPreset.Ring or RmgTopologyPreset.DividedLands && (settings.MapSize is 128 or 256 || (settings.MapSize is 64 or 512 && settings.GeneratorVersion is 16 or 17 or 18 or 19 or 20 or 21)))
			{
				var profile = Load(modData, $"sa|rmg/normal-{(settings.GeneratorVersion == 21 ? "divided-lands" : settings.GeneratorVersion == 20 ? "ring" : settings.GeneratorVersion == 19 ? "crossroads" : settings.GeneratorVersion == 18 ? "artificial-battlefield" : "natural-regions")}-v{(settings.GeneratorVersion is 12 or 13 or 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21 ? settings.GeneratorVersion : 11)}{(settings.MapSize == 128 ? string.Empty : $"-{settings.MapSize}")}.yaml");
				if (!RmgBiome.IsSupported(settings.Tileset) || (settings.Tileset != "NORMAL" && settings.GeneratorVersion is not (16 or 17 or 18 or 19 or 20 or 21)))
