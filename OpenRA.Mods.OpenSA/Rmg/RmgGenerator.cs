	...
	public static partial class RmgGenerator
	{
		...
		static void ValidateSettings(RmgProfile profile, RmgGenerationSettings settings)
		{
			...
			if (!RmgBiome.IsSupported(settings.Tileset) || settings.Tileset != profile.Tileset ||
				(settings.Tileset != "NORMAL" && (settings.GeneratorVersion is not (16 or 17 or 18 or 19 or 20 or 21 or 22 or 23 or 24) || !profile.UsesRegionsTerrain)))
			...
			if (!Enum.IsDefined(settings.WaterAmount) || !Enum.IsDefined(settings.TacticalTerrain) ||
				(settings.GeneratorVersion is not (14 or 15 or 16 or 17 or 18 or 19 or 20 or 21 or 22 or 23 or 24) && (settings.WaterAmount > RmgParameterLevel.High ||
			...
			settings.NeutralColonyWeights.Validate(settings.GeneratorVersion is 16 or 17 or 18 or 19 or 20 or 21 or 22 or 23 or 24 ? 100 : 1000);
			RmgColonyOwnership.ValidateShares(settings.StartingColonyShares, settings.PlayerCount);
			if (!settings.RespectStartingSafeArea && settings.GeneratorVersion is not (16 or 17 or 18 or 19 or 20 or 21 or 22 or 23 or 24))
			...
			if (!Enum.IsDefined(settings.StartingColonyMode) || (settings.GeneratorVersion is not (16 or 17 or 18 or 19 or 20 or 21 or 22 or 23 or 24) && settings.StartingColonyMode != RmgColonyOwnershipMode.ClosestToSpawn))
				throw new ArgumentException("Starting colony mode requires Regions V16 and a valid choice.");
			if (settings.GeneratorVersion is not (16 or 17 or 18 or 19 or 20 or 21 or 22 or 23 or 24) && settings.StartingColonyShares.Length != 0)
