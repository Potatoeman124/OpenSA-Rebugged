...
Write-Host "Focused V1-V8, inherited-baseline, parameter-matrix, terrain-catalogue, materializer, and native-validator RMG self-tests passed." -ForegroundColor Green
